...
SHOW_OUTPUTS_PATTERN="\\( -name 'openwrt-x86-64-generic-*combined*.img.gz' -o -name 'openwrt-x86-64-generic-*combined*.img' -o -name 'openwrt-x86-64-generic-rootfs.tar.gz' -o -name 'sha256sums' -o -name 'profiles.json' \\)"
